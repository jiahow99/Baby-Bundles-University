...
if(isset($_POST['upload'])){
    ...
    if(preg_match($price_pattern, $price)){
        ...
        // Insert Query
        $dbcontroller->insertQuery("INSERT INTO product_table(`title`, `category`, `description`, `condition`, `price`, `userid`, `image`) VALUES ( '$title', '$category', '$description', '$condition', '$price', '$userid', '$target_file')");
    }else{
        ...
        <div id="content" style="background-color:#F2F2F2">
            ...
            <form class="container glass" id="edit-product" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <select class="form-select col-2 ml-3" aria-label="Default select example" name="category">
