            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    success:function(product)
                    {
                        ...
                        for(i=0 ; i<len; i++){
                            var str = '<div class="col-3 mb-5"><a href="admin-editproduct.php" class="card" ><img class="card-img-top" src="' + product[i].image +'" style="width:268px;height:270px;"><div class="card-body">' +
