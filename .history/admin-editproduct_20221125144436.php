            ...
            <form class="container glass" id="edit-product" method="post">
                ...
                <div class="row">
                    ...
                    <select name="category" id="category" class="ml-3">
                        ...
                        <option value="bottom" <?php category('bottom') ?>>Bottom</option>
                        <option value="socks" <?php category('socks') ?>>Socks</option>
                        <option value="toy" <?php category('toy') ?>>Toy</option>
                        <option value="babycart" <?php category('babycart') ?>>Baby Cart</option>
                        <option value="accessories" <?php category('accessories') ?>>Accessories</option>
                    </select>
                </div>
                <!-- Product Price -->
                <div class="row">
