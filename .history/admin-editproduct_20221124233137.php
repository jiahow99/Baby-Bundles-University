        ...
        <div id="content" style="background-color:#F2F2F2">
            ...
            <form class="container glass" id="edit-product">
                ...
                <div class="row">
                    ...
                    <input class="input--style-6 col-10 ml-3" type="text" name="title" value="<?php if(isset($result)){echo $result['title'];} ?>" placeholder="Enter product title" required autofocus>
                </div>

                <div class="row">
                    <label for="" class="name text-uppercase col-12">Price</label>
                    <input class="input--style-6 col-1 ml-3" type="text" name="title" value="RM <?php if(isset($result)){echo $result['price'];} ?>" placeholder="RM" required>
                </div>

                <div class="row mb-4">
                    <label for="" class="name text-uppercase col-12">Description</label>
                    <textarea name="description" class="textarea--style-6 ml-3 col-9" value="<?php if(isset($result)){echo $result['description'];} ?>" rows="5"></textarea>
                </div>
