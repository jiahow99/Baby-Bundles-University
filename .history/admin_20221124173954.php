            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    success:function(product)
                    {
                        ...
                        for(i=0 ; i<len; i++){
                            var str = '<a href="#" class="card" ><img class="card-img-top" src="' + product[i].image +'" ><div class="card-body">' +
                            '<div class="row"><div class="col-9"><h6>' + product[i].title + '</h6><p>RM ' + product[i].price + '</p>';
