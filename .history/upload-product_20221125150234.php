                        ...
                        <div class="form-row">
                            ...
                            <div class="name text-uppercase">Price</div>
                                <div class="value">
                                    ...
                                    <div class="text-danger text-sm">** <?php if(isset($_SESSION['price_err'])){ echo $_SESSION['price_err']; unset($_SESSION['price_err']);} ?></div>
                                </div>
                        </div>  
                        <div class="form-row">
                            <!-- Product Image -->
                            ...
                            <div class="value">
                                ...
                                <div class="text-danger pt-2 text-sm"><?php if(isset($_SESSION['image_err'])){echo $_SESSION['image_err'];unset($_SESSION['image_err']);} ?></div>
