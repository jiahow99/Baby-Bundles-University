                                ...
                                <div class="col">
                                    <div class="product card border-0" style="width:280px;">
                                        ...
                                        <div class="overflow-hidden">
                                            <a href="#"><img class="card-img-top img-fluid" style="width:270px;height:290px;" src="<?php echo $shoes['image'] ?>" alt="..." /></a>
                                        </div>
                                        <!-- Product details-->
                                        <div class="card-body pt-3 pb-3" style="height:170px;">
                                            <div>
                                                ...
                                                <div class="row " style="height:40px;">
                                                    <h6 class="justify-content-start col-10 "><?php echo mb_strimwidth($shoes['title'], 0, 40, "...") ?></h6>
                                                    <i class="fa fa-heart justify-content-end col-2"></i>
                                                </div>
                                                <!-- Product condition-->
                                                <div class="d-flex small mb-1 gap-1">
                                                    <?php
                                                        for ($x=0; $x<$shoes['condition']; $x++) { 
                                                            echo '<i class="bi bi-star-fill star-filled"></i>';
                                                        }

                                                        $unfill_star = 5 - $shoes['condition'];
                                                ...
                                                <!-- Product price-->
                                                <span class="text-primary fw-bold text-lg">RM <?php echo $shoes['price'] ?></span>
                                            </div>
