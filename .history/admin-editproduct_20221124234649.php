...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content" style="background-color:#F2F2F2">
            ...
            <form class="container glass" id="edit-product" action="post">
                ...
                <div class="row">
                    ...
                    <input class="input--style-6 col-2 ml-3" type="text" name="title" value="<?php if(isset($result)){echo $result['price'];} ?>" placeholder="RM" required>
                </div>
                ...
                <div class="row justify-content-center my-5 ">
                    <button class="btn btn-primary px-5 py-3 mr-5" type="submit" name="delete">Delete</button>
                    <button class="btn btn-primary px-5 py-3" type="submit" name="update">Update</button>
                </div>
