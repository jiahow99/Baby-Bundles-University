            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    success:function(product)
                    {
                        ...
                        for(i=0 ; i<len; i++){
                            var str = '<div class="col-3"><a href="#" class="card" ><img class="card-img-top" src="' + product[i].image +'" style="width:268px;height:270px;"><div class="card-body">' +
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- Display all product -->
            <div class="row mx-3 my-4" id="product">
                <div class="col-3">
                    <!-- Product card -->
