...
if(isset($_GET['userid'])){
    ...
    if(isset($_POST['submit'])){
        ...
        // pattern
        $username_pattern = "/^[0-9a-zA-Z-' ]{4,10}$/";
        ...
        $same_username = $dbcontroller->numRows("SELECT username from login_table WHERE username='$username'");
        ...
        $same_email = $dbcontroller->numRows("SELECT email from login_table WHERE email='$email'");
