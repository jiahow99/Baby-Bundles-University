            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    success:function(product)
                    {
                        ...
                        for(i=0 ; i<len; i++){
                            var str = '<div class="col-3 mb-5"><a href="#" class="card" ><img class="card-img-top" src="' + product[i].image +'" style="width:268px;height:270px;"><div class="card-body">' +
            ...
            <div class="container" id="users">
                ...
                <div class="row bg-transparent rounded py-2 mb-2 user-row align-items-center">
                    ...
                    <div class="col-4 user">
                        <a href="admin-viewuser.php?action=edit&userid=1" class="btn btn-primary"><i class="bi bi-pencil"></i></a>
                        <a href="admin-viewuser.php?action=remove&userid=1" class="btn btn-primary"><i class="bi bi-trash3-fill"></i></a>
                    </div>
                </div>
