        ...
        <div class="row">
          <div class="col-lg-6 order-2 order-lg-1">
            ...
            <ul class="list-check list-unstyled row px-3 mb-4 gy-2">
              <li class="text-sm text-muted col-lg-6">Top</li>
              <li class="text-sm text-muted col-lg-6">Bottom</li>
              <li class="text-sm text-muted col-lg-6">Shoes</li>
              <li class="text-sm text-muted col-lg-6">Outgoing asseccories</li>
              <li class="text-sm text-muted col-lg-6">Socks</li>
              <li class="text-sm text-muted col-lg-6">Toys</li>
            </ul> 
