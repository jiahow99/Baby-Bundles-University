        ...
        <section class="img-fluid bg-secondary py-6" style="padding-top:150px;background-image: url(img/top-banner.jpg);background-position: center;background-size: cover;">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="text-lg fw-bolder text-white">Bottom</h1>
                </div>
            </div>
        </section>
        <!-- Section-->
                                ...
                                <div class="col">
                                    <div class="product card border-0" style="width:250px;">
                                        ...
                                        <div class="overflow-hidden">
                                            <?php echo "<a href='product-page.php?id=".$bottom['product_id']."'><img class='card-img-top' style='width:250px;height:260px;' src='".$bottom['image']."'</a>"; ?>
                                        </div>
                                        <!-- Product details-->
                                        <div class="card-body pt-3 pb-3" style="height:120px;">
                                            <div>
                                                ...
                                                <div class="row " style="height:40px;">
                                                    <h6 class="justify-content-start col-10 text-black"><?php echo mb_strimwidth($bottom['title'], 0, 40, "...") ?></h6>
                                                    <!-- Favourite icon -->
                                                ...
                                                <!-- Product price-->
                                                <div class="row">
                                                    <span class="text-primary fw-bold text-lg col-9 justify-content-start">RM <?php echo $bottom['price'] ?></span>
                                                </div>
                                            </div>
