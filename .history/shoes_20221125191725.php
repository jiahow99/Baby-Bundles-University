        ...
        <section class="img-fluid bg-secondary py-6" style="padding-top:150px;background-image: url(img/top-banner.jpg);background-position: center;background-size: cover;">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="text-lg fw-bolder text-white">Shoes</h1>
                </div>
            </div>
        </section>
        <!-- Section-->
        <section class="pt-5">
            <div class="container px-4 px-lg-5 mt-2">
                <div class="row gx-2 gx-lg-0 gy-lg-4 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    $shoes_array = $db_controller->selectProduct("SELECT * FROM product_table WHERE category='shoes' ORDER BY product_id ASC");

                    if(!empty($shoes_array)){

                        foreach($shoes_array as $socks){ ?>
                            <!-- Product Display -->
                                ...
                                <div class="col">
                                    <div class="product card border-0" style="width:250px;">
                                        ...
                                        <div class="overflow-hidden">
                                            <?php echo "<a href='product-page.php?id=".$socks['product_id']."'><img class='card-img-top' style='width:250px;height:260px;' src='".$socks['image']."'</a>"; ?>
                                        </div>
                                        <!-- Product details-->
                                        <div class="card-body pt-3 pb-3" style="height:120px;">
                                            <div>
                                                ...
                                                <div class="row " style="height:40px;">
                                                    <h6 class="justify-content-start col-10 text-black"><?php echo mb_strimwidth($socks['title'], 0, 40, "...") ?></h6>
                                                    <!-- Favourite icon -->
                                                ...
                                                <!-- Product price-->
                                                <div class="row">
                                                    <span class="text-primary fw-bold text-lg col-9 justify-content-start">RM <?php echo $socks['price'] ?></span>
                                                </div>
                                            </div>
