                ...
                $.ajax({
                    ...
                    success:function(user)
                    {
                        ...
                        for(i=0 ; i<len; i++){
                            ...
                            '<div class="col-1 user">' + user[i].userid + '</div>' +
                            '<div class="col-1 user">' + user[i].username + '</div>' +
                            '<div class="col-2 user">' + user[i].email + '</div>' +
                            '<div class="col-2 user">+' + user[i].contact + '</div>' +
                            '<div class="col-1 user">' + user[i].gender + '</div>' +
                            '<div class="col-4 user">' + user[i].location + '</div>' +
                            '<div class="col-1 user">' +
                            '<a href="admin-viewuser.php?action=edit&userid=' + user[i].userid + '" class="btn btn-primary mb-4">EDIT</a>' +
