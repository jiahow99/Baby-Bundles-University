        ...
        <div id="content" style="background-color:#F2F2F2">
            ...
            <form class="container glass" id="edit-product">
                ...
                <div class="form-group">
                    <label for="" class="name text-uppercase">Title</label>
                    <input class="input--style-6 form-control" type="text" name="title" placeholder="Enter product title" required autofocus>
                </div>
            </form>
    </div>
