...
if(isset($_POST['upload'])){
    ...
    if(preg_match($price_pattern, $price)){
        ...
        // Insert Query
        $dbcontroller->insertQuery("INSERT INTO product_table(`title`, `category`, `description`, `condition`, `price`, `userid`, `image`) VALUES ( '$title', '$category', '$description', '$condition', '$price', '$userid', 'null')");
    }else{
