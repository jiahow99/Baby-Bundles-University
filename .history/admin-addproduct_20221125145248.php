...
if(isset($_POST['upload'])){
    ...
    if(preg_match($price_pattern, $price)){
        $dbcontroller->insertQuery("INSERT INTO product_table(`product_id`, `title`, `category`, `description`, `condition`, `price`, `userid`, `image`) VALUES (NULL, '$title', '$category', '$description', '$condition', '$price', '$userid', '$target_file')");
    }else{
