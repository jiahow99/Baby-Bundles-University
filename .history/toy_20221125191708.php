        ...
        <section class="img-fluid bg-secondary py-6" style="padding-top:150px;background-image: url(img/top-banner.jpg);background-position: center;background-size: cover;">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="text-lg fw-bolder text-white">Toy</h1>
                </div>
            </div>
        </section>
        <!-- Section-->
        <section class="pt-5">
            <div class="container px-4 px-lg-5 mt-2">
                <div class="row gx-2 gx-lg-0 gy-lg-4 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    $toy_array = $db_controller->selectProduct("SELECT * FROM product_table WHERE category='toy' ORDER BY product_id ASC");

                    if(!empty($toy_array)){

                        foreach($toy_array as $toy){ ?>
                            <!-- Product Display -->
                                ...
                                <div class="col">
                                    <div class="product card border-0" style="width:250px;">
                                        ...
                                        <div class="overflow-hidden">
                                            <?php echo "<a href='product-page.php?id=".$toy['product_id']."'><img class='card-img-top' style='width:250px;height:260px;' src='".$toy['image']."'</a>"; ?>
                                        </div>
                                        <!-- Product details-->
                                        <div class="card-body pt-3 pb-3" style="height:120px;">
                                            <div>
                                                ...
                                                <div class="row " style="height:40px;">
                                                    <h6 class="justify-content-start col-10 text-black"><?php echo mb_strimwidth($toy['title'], 0, 40, "...") ?></h6>
                                                    <!-- Favourite icon -->
                                                ...
                                                <div class="d-flex small mb-1 gap-1">
                                                    <?php
                                                        for ($x=0; $x<$toy['condition']; $x++) { 
                                                            echo '<i class="bi bi-star-fill star-filled"></i>';
                                                        }

                                                        // $y = 5 - $toy['condition'];
                                                        $unfill_star = 5 - $toy['condition'];
                                                ...
                                                <!-- Product price-->
                                                <div class="row">
                                                    <span class="text-primary fw-bold text-lg col-9 justify-content-start">RM <?php echo $toy['price'] ?></span>
                                                </div>
                                            </div>
