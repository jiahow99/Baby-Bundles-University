...
if(isset($_GET['userid'])){
    ...
    if(isset($_POST['submit'])){
       ...
       if(!filter_var( $email, FILTER_VALIDATE_EMAIL )){
        ...
        if(empty($errormsg)){
            $insert = "UPDATE login_table SET username='$username', email='$email', contact='$contact', location='$location', gender='$gender', is_admin=$_POST['is_admin'] WHERE userid='$edit_id'";
    ...
    <div class="wrapper">
        ...
        <div id="content" style="background-color:#F2F2F2">
            ...
            <form class="container glass" id="edit-product" method="post">
                ...
                <!-- Admin Assign -->
                <div class="row ">
                    <label for="is_admin" class="name text-uppercase col-12">Is Admin</label>
                    <input type="radio" class=" ml-3" name="is_admin" id="is_admin" value='1'>Admin
                    <input type="radio" class=" ml-3" name="is_admin" id="is_admin" value='0'>Normal User
                </div>
