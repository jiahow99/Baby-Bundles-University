        ...
        <div id="content" style="background-color:#F2F2F2">
            ...
            <section id="dashboard">
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                    <a class="card text-white card-has-bg click-col" style="background-image:url('https://source.unsplash.com/600x900/?computer,design');">
                            ...
                            <div class="card-img-overlay d-flex flex-column">
                                <div class="card-body">
                                    <h2 class="card-title" style="position:absolute;top:200px;left:110px;">
                                        <a class="text-white text-center" herf="admin-viewuser.php">ADD USER</a>
                                    </h2>
                                </div>
                            </div>
</a>
