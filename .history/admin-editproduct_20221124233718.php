    ...
    <div class="wrapper">
        ...
        <div id="content" style="background-color:#F2F2F2">
            ...
            <form class="container glass" id="edit-product">
                ...
                <input class="input--style-6 ml-3" type="text" name="username" value="<?php if(isset($seller)){echo $seller['username'];} ?>" >
                </div>

                <div class="form-group ">
                <label for="" class="name text-uppercase col-2">Contact No :</label>
                <input class="input--style-6 ml-3" type="text" name="contact"  value="<?php if(isset($seller)){echo $seller['contact'];} ?>">
                </div>

                <div class="form-group">
                <label for="" class="name text-uppercase col-2">Email Address :</label>
                <input class="input--style-6 ml-3" type="email" name="email" value="<?php if(isset($seller)){echo $seller['email'];} ?>" >
                </div>
