...
if(isset($_GET['action'])){
    ...
    switch ($_GET['action']) {
        ...
        case 'placeorder':
            $insert = "INSERT INTO order_table(userid,product,total_price) VALUES('$userid','$listproductstr','$totalPrice')";
...
if(isset($_POST['order'])){
    ...
    $insert = "INSERT INTO order_table(userid,product,price) VALUES('$userid','$listproductstr','$totalPrice')";
    $result = $db_controller->insertQuery($insert);
}
?>
        ...
        <div class="card mt-6" >
            <div class="row">
                ...
                <div class="col-md-4 summary">
                    ...
                    <form method="post">
                    <button type="submit" class="btnn" name="placeorder">Place Order</button>
                    </form>
                </div>
