...
if(isset($_POST['submit'])){
    ...
    if(isset($_POST['category'])){
        ...
        if(preg_match($price_pattern, $price)){
            $db_controller->insertQuery("INSERT INTO product_table(`product_id`, `title`, `category`, `description`, `condition`, `price`, `userid`, `image`) VALUES (NULL, '$title', '$category', '$description', '$condition', '$price', '1', '$target_file')");
        }else{
