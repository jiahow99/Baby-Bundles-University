        ...
        <div id="content" style="background-color:#F2F2F2">
            ...
            <div class="container" id="users">
                ...
                <div class="row bg-secondary rounded py-3 mb-3">
                    ...
                    <div class="col-3 text-white">Contact No</div>
                    <div class="col-2 text-white">Gender</div>
                    <div class="col-2 text-white">Location</div>
                    <div class="col-2 text-white">Action</div>
                </div>
