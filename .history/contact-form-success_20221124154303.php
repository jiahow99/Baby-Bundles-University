	...
	<body>
		...
		<div class="wrapperr">
			<div class="inner">
                ...
                <p class="text-black">Ticket : <?php echo $contact_form_id ?></p>
                <p class="text-black">Name : <?php echo $_POST['name'] ?></p>
                <p class="text-black">E-mail : <?php echo $_POST['email'] ?></p>
                <p class="text-black">Reason : <?php echo $_POST['reason'] ?></p>
			</div>
		</div>
