...
if(isset($_POST['update'])){
    ...
    $update = "UPDATE product_table SET title='$new_title', price='$new_price', description='$new_description' WHERE product_id='$productid'";
            ...
            <form class="container glass" id="edit-product" method="post">
                ...
                <div class="row">
                    ...
                    <select name="category" id="category" class="ml-3">
                        <option value="top" <?php echo category($result['category']) ?>>Top</option>
                        <option value="bottom" <?php echo category($result['category']) ?>>Bottom</option>
                        <option value="socks" <?php echo category($result['category']) ?>>Socks</option>
                        <option value="toy" <?php echo category($result['category']) ?>>Toy</option>
                        <option value="babycart" <?php echo category($result['category']) ?>>Baby Cart</option>
                        <option value="accessories" <?php echo category($result['category']) ?>>Accessories</option>
                    </select>
                </div>
                <!-- Product Price -->
                <div class="row">
