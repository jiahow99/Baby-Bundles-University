<nav class="navbar navbar-expand-lg navbar-light bg-admin" style="position:relative;z-index:1000px">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown mx-lg-3 col-2 col-lg-1" >
                    ...
                    <div class="dropdown-menu text-sm" style="z-index:1000;" aria-labelledby="userDropdownMenuLink">
