...
if(isset($_POST['confirm'])){
    ...
    $insert = "UPDATE login_table SET username='$tempname', email='$email', contact='$contact', gender='$gender', location='$location' WHERE userid=$user_id ";
            ...
            <div class="row row-info">
                ...
                <div class="col">
                    <div class="row mt-3">
                        ...
                        <div class="col-5 ms-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="input row" name="email" value="<?php if(isset($_COOKIE['email'])){ echo $_COOKIE['email'];} ?>">
                            </div>
                        </div>
                    </div>
                    <!-- Contact and Gender -->
                    <div class="row mt-3">
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="input row" name="contact">
                            </div>
                        </div>
                    ...
                    <div class="form-group my-3">
                        ...
                        <textarea name="location" class="input row" id="address" rows="3" cols="60"></textarea>
                    </div>
                </div>
            </div>
            <!-- password row -->
