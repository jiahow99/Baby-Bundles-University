...
// Order Placed popup
if(isset($_SESSION['order_placed']) and $_SESSION['orderplaced']){
...
if($num_rows > 0){
    ...
    // Get Total Price
    if(!empty($products) and !empty($products['product'])){
    ...
    switch ($_GET['action']) {
        ...
        case 'remove':
            if(in_array($productid, $items_array)){
                ...
                // Update database
                $query = "UPDATE shopping_cart_table SET product='$new_items_array' WHERE userid='$userid'";
        ...
        case 'placeorder':
            ...
            // Refresh page
            die(header("Location:shopping-cart.php"));
            break;
    }
}
