          ...
          if(isset($_COOKIE['username'])){ ?>
            ...
            <li>
              <form class="d-flex ms-lg-3 my-2 mx-lg-0">
                <a class="btn btn-outline-dark" href="shopping-cart.php" style="padding-top: 0.37rem;padding-bottom: 0.37rem;">
                    <i class="bi-cart-fill me-1"></i>
                    Cart
                    <span class="badge bg-dark text-white ms-1 rounded-pill">13</span>
                </a>
              </form>
            </li>
            ...
            <li class="nav-item dropdown mx-lg-3 col-2 col-lg-1" >
              ...
              <div class="dropdown-menu text-sm " aria-labelledby="userDropdownMenuLink">
                ...
                <?php if(isset($_COOKIE['is_admin'])){
                  echo '<a href="admin-dashboard.php" class="dropdown-item">Admin Managament</a>';
                } 
                ?>
