...
if(isset($_POST['upload'])){
    ...
    if(preg_match($price_pattern, $price)){
        ...
        // Insert Query
        $db_controller->insertQuery("INSERT INTO product_table(`product_id`, `title`, `category`, `description`, `condition`, `price`, `userid`, `image`) VALUES (NULL, '$title', '$category', '$description', '$condition', '$price', '$userid', 'null')");
    }else{
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content" style="background-color:#F2F2F2">
            ...
            <form class="container glass" id="edit-product" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <input class="input--style-6 col-1 ml-3" type="text" name="title" placeholder="RM" required>
                </div>
                <!-- Error Message (Price) -->
